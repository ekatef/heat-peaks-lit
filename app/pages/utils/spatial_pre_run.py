...
def get_onshore_regions():
    ...
    # RESULTS_DIR=os.path.join("/Users/ekaterina/Documents/_github_/pypsa-africa-aux/pypsa_earth_lit2/resources")
    # RESULTS_DIR=os.path.join("/Users/ekaterina/Documents/_github_/pypsa-africa-aux/pypsa_earth_lit3/resources")
    name_geo_dict = {}
...
def _get_gen_df(network, gpd_bus_regions):
    ...
    res_carriers_names = ["solar", "onwind"]
...
def make_dict_senario(pypsa_network, polygon_gpd):
    ...
    points.geometry = gpd.points_from_xy(x, y, crs=3035) # crs=4326)
